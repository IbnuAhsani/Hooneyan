	...
	<div class="row" style="height: 1100px">
		...
		<div class="col-7">
			...
			<div class="row">
				<div class="mySlides fade polaroid">
					...
					<img src="<?php echo base_url(); ?>/assests/pictures/rumah1.jpg" style="width:100%">
				</div>

				<div class="mySlides fade polaroid">
					<div class="numbertext">2 / 3</div>
					<img src="<?php echo base_url(); ?>/assests/pictures/rumah2.jpg" style="width:100%">
				</div>

				<div class="mySlides fade polaroid">
					<div class="numbertext">3 / 3</div>
					<img src="<?php echo base_url(); ?>/assests/pictures/rumah3.jpg" style="width:100%">
				</div>	
			</div>
		...
		<div class="col-3 round1 polaroid" style="height: 310px">
			<form action="/action_page.php" style="text-align: center; margin: 0 auto ">
				...
				<img src="<?php echo base_url(); ?>/assests/pictures/Profile_pic.png" height="144px" width="144px">
				<h1>Nama Agen</h1>
				<br>
