...
<body class="container-fluid" style="margin: 0"px>
   ...
   <ul style="background-color: #062F4f; width: 100% ; margin: 0px">
	...
	<div class="row">
		...
		<div class="col-6">
			<br><br>		
			<form class="iklan-box" style="padding-left: 8%;" id="properti_data" action="<?php echo base_url('index.php/Properti_Page/update_data'); ?>" method="post"  enctype="multipart/form-data">
