...
<body class="container-fluid" style="margin: 0"px>   
   ...
   <div class="cycle-slideshow">
     ...
     <img class="home_page carousel-size-homepage" src="../Pictures/rumah1.jpg" alt="Gambar Pertama">
     <img class="home_page carousel-size-homepage" src="../Pictures/rumah2.jpg" alt="Gambar Kedua">
     <img class="home_page carousel-size-homepage" src="../Pictures/rumah3.jpg" alt="Gambar Ketiga">
   </div>
  ...
  <div class="row" id="kiri">
    <div class="col-sm-4"><img src="../Pictures/rumah1.jpg" alt="rumah1" style="width:304px;height:228px;">
      <br>
      <h3>Meikarta</h3>
      <h5>Cikarang, Bekasi</h5>
    </div>
    <div class="col-sm-4"><img src="../Pictures/rumah2.jpg" alt="rumah2" style="width:304px;height:228px;">
      <br>
      <h3>Griya Bandung Indah</h3>
      <h5>Ciwastra, Bandung</h5>
    </div>
    <div class="col-sm-4 "><img src="../Pictures/rumah3.jpg" alt="rumah3" style="width:304px;height:228px;">
      <br>
      <h3>Margahayu</h3>
